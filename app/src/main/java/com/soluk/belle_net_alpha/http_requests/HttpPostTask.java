...
class HttpPostTask extends AsyncTask<String,Void,String>
{
  ...
  private String getPostDataString(Map<String, String> params) throws UnsupportedEncodingException
  {
    ...
    boolean first = true;
    JSONObject body_key_values = new JSONObject();
    for(Map.Entry<String, String> entry : params.entrySet())
    {
      ...
      try
      {
        body_key_values.put(entry.getKey(),entry.getValue());
      }
      catch (Exception e)
      {
    ...
    Log.d("TAG", "Result: "+body_key_values.toString());
    return body_key_values.toString();
  }
}
