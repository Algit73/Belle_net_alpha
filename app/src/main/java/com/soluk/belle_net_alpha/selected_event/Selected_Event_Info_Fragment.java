...
public class Selected_Event_Info_Fragment extends Fragment
{
    ...
    TextView event_start_time_tv;
    TextView event_end_time_tv;
    TextView event_joined_num_tv;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        set_elements_views(view);
        set_date_time(feature);
        set_owner_name(feature);
        set_user_picture_profile(feature);





        event_joined_num_tv.setText(feature.getStringProperty(Events_DB_VM.NUM_OF_JOINED));
    ...
    private void set_user_picture_profile(Feature feature)
    {
        String event_category = feature.getStringProperty(EVENT_CATEGORY);
        if (event_category.equals("0"))
            user_profile_image_civ.setImageBitmap(Image_Provider
                    .get_profile_bmp(feature.getStringProperty(Events_DB_VM.USER_PIC)));
        else
            user_profile_image_civ.setImageBitmap(Image_Provider
                    .get_profile_bmp(feature.getStringProperty(Events_DB_VM.BUSINESS_PIC)));

    }

    private void set_owner_name(Feature feature)
    {
        String event_category = feature.getStringProperty(EVENT_CATEGORY);
        String owner_name;
        if (event_category.equals("0"))
        owner_name = feature.getStringProperty(Events_DB_VM.USER_NAME) + " "+
                feature.getStringProperty(Events_DB_VM.USER_FAMILY);
        else
            owner_name = feature.getStringProperty(Events_DB_VM.BUSINESS_NAME);
        owner_name_tv.setText(owner_name);
    }

    private void set_date_time(Feature feature)
    {
...
//        Log.d(TAG,"Date_time end_date_time: "+ end_date_time);
    ...
    private void set_elements_views(View view)
    {
        event_start_date_tv = view.findViewById(R.id.event_start_date_tv);
        event_end_date_tv = view.findViewById(R.id.event_end_date_tv);
        event_start_time_tv = view.findViewById(R.id.event_start_time_tv);
        event_end_time_tv = view.findViewById(R.id.event_end_time_tv);
        event_joined_num_tv = view.findViewById(R.id.event_joined_num_tv);
        owner_name_tv = view.findViewById(R.id.user_name_family_tv);
